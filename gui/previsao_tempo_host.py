...
class GuiManager:
    ...
    def lf_criar_rotulo_resultado(self, args):
        ...
        id, texto = args[0], args[1]
        rotulo = tk.Label(self.root, text=texto, font=("Arial", 24, "bold"), bg="lightgray", padx=10, pady=10)
        rotulo.pack(pady=10)
...
def setup_analyzer():
    ...
    gui_semantic_scope.define(BuiltInFunctionSymbol('criar_rotulo_resultado', params=[VarSymbol('id', string_type), VarSymbol('texto', string_type)], return_type=null_type))
...
def main():
    ...
    try:
        with open("previsao_tempo.lf", 'r', encoding='utf-8') as f: source_code = f.read()
